...
typedef volatile uint8 vuint8;   // 易变(volatile) 无符号 8 bits
typedef volatile uint16 vuint16; // 易变(volatile) 无符号 16 bits
// typedef volatile uint32 vuint32; // 易变(volatile) 无符号 32 bits
// typedef volatile uint64 vuint64; // 易变(volatile) 无符号 64 bits

typedef volatile int8 vint8;   // 易变(volatile) 有符号 8 bits
typedef volatile int16 vint16; // 易变(volatile) 有符号 16 bits
// typedef volatile int32 vint32; // 易变(volatile) 有符号 32 bits
// typedef volatile int64 vint64; // 易变(volatile) 有符号 64 bits
